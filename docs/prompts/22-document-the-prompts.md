...
- `docs/tooling/` — per-script docs for `extract_seda_subset`, `compute_deltas`, `build_chart13`, `build_chart_troy_swd`, `analyze_troy_swd`, `check_style_drift`, and `troy_swd_ela` (in `tools-schooldata`).
